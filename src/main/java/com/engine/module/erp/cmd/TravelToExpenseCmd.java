 ...
 */
public class TravelToExpenseCmd extends WorkflowCommand<Boolean> {
    ...
    public Boolean execute(CommandContext commandContext) {
        ...
        log.info("#TravelToExpenseCmd 差旅报销推送ERP收支单 ====== " + requestId);
    ...
    private com.engine.module.erp.entity.InComeAndExpensesEntity getInComeAndExpensesEntity(Map<String, Object> mainData) {
        ...
        com.engine.module.erp.entity.InComeAndExpensesEntity inCome = InComeAndExpensesEntity.builder()
                ...
                .exchange_rate("1")
                .trans_curr_amount(new BigDecimal(Util.null2String(mainData.get("sjbxje"))))
